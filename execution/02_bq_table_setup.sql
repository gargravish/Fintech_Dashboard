...
--   2. Replace `${GCP_PROJECT_ID}` with your GCP project ID
--   3. Replace `${BQ_DATASET}` with your dataset name
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.raw_transactions` (
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.user_features_15m` (
    user_id              STRING NOT NULL,
    tx_count             INT64,
    total_spend          FLOAT64,
    avg_amount           FLOAT64,
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.user_features_30m` (
    user_id              STRING NOT NULL,
    tx_count             INT64,
    total_spend          FLOAT64,
    avg_amount           FLOAT64,
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.user_features_60m` (
    user_id              STRING NOT NULL,
    tx_count             INT64,
    total_spend          FLOAT64,
    avg_amount           FLOAT64,
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.aml_alerts` (
    transaction_id STRING NOT NULL,
    user_id        STRING NOT NULL,
    alert_type     STRING,
    amount         FLOAT64,
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.user_recommendations` (
    user_id        STRING,
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.feature_ideation` (
    source_table      STRING,
...
CREATE TABLE IF NOT EXISTS `${GCP_PROJECT_ID}.${BQ_DATASET}.user_baseline_14d` (  
    user_id              STRING NOT NULL,  
